...
var haas_tools_1 = require("@/lib/ai/haas-tools");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var tenantId, fleetSummary, billingTier, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    tenantId = '71cc83b5-cba4-430f-be33-8200dbb8c90f';
                    console.log("Running tests for Tenant ID: ".concat(tenantId, "\n"));
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    console.log('--- Testing getFleetHealthSummary ---');
                    return [4 /*yield*/, (0, haas_tools_1.getFleetHealthSummary)(tenantId)];
                case 2:
                    fleetSummary = _a.sent();
                    ...
                    return [4 /*yield*/, (0, haas_tools_1.getCurrentBillingTier)(tenantId)];
                case 3:
                    billingTier = _a.sent();
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('Error during testing:', error_1);
                    return [3 /*break*/, 5];
